//package com.jwt.jwt.security_Sample;
//
...
//		UserDetails user1=User.withUsername("loaduser").password(encoder().encode("123")).roles("USER").build();
...
//				.requestMatchers("/loaduser").hasAnyRole("USER","ADMIN")
